...
```{r, echo=FALSE, fig.cap="File sizes by format and dataset size", out.width = "650px", fig.align='center'}
knitr::include_graphics('p_file_sizes.png')
```
...
```{r, echo=FALSE, fig.cap="Write performance by format and dataset size", out.width = "650px", fig.align='center'}
knitr::include_graphics('p_write_benchmark.png')
```
...
```{r, echo=FALSE, fig.cap="Read performance by format and dataset size", out.width = "650px", fig.align='center'}
knitr::include_graphics('p_read_benchmark.png')
```
...
```{r, echo=FALSE, fig.cap="Memory usage by format and dataset size", out.width = "650px", fig.align='center'}
knitr::include_graphics('p_memory_usage.png')
```
